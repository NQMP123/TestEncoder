...
//                colorName = "orange";
//                colorMap = "red";
//                if (RongThanFactory.findCharInMap(name) != null)
//                    colorName = "red";
//            }
...
//                int length = RongThanGraphics.getWidth(styles[i - start + offset], $"{i + 1}. {boss}");
...
//                if (GameCanvas.isMouseFocus(xDraw, yDraw, maxLength, 7))
//                    RongThanGraphics.fillRect(xDraw + 1, yDraw + 7, (maxLength - 2) * mGraphics.zoomLevel + 2, 1, Color.white);
...
//            titleWidth = RongThanGraphics.getWidth(style, LIST_BOSS);
//            g.setColor(new Color(.2f, .2f, .2f, .7f));
...
//        {
//            if (lastBoss != -1 && mSystem.currentTimeMillis() - RongThanGraphics.GetLastTimePress() > 200)
//                lastBoss = -1;
//            if (!isEnabled)
//                return;
...
//                        else
//                        {
//                            if (lastBoss == i && mSystem.currentTimeMillis() - RongThanGraphics.GetLastTimePress() <= 200)
//                            {
...
//                                        else
//                                            RongThanFactory.teleportMyChar(ch);
//                                        break;
//                                    }
//                                }
