...
public class Item
{
	...
	public static List<int> tempIDHoTro = new List<int>();
	public static bool CheckItemHoTro(Item item)
	{
		return tempIDHoTro.Contains(item.template.id);
	}

    public static List<int> itemIDPhuKien = new List<int>();
    public static List<int> typePhuKien = new List<int>();
    public static bool CheckItemPhuKien(Item item)
    {
        if (itemIDPhuKien.Contains(item.template.id))
        {
            return true;
        }
        if (typePhuKien.Contains(item.template.type))
		{
			return true;
		}
        return false;
	...
	public static List<sbyte> typeBody = new List<sbyte>();
	public bool isTypeBody()
	{
		...
		if (typeBody.Contains(template.type))
		{
			return true;
		}
		return false;
