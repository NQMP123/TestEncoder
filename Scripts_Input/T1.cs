public class T1 : mResources
{
	public static void load()
	{
		...
		mResources.updSkill = "Khi đạt tối đa thành thạo, hãy đến Whis Whis(Hành tinh Bill) để nâng cấp tuyệt kỹ";
		...
		mResources.LOGINLABELS = new string[2] { "Chưa có tài khoản xin", "chọn menu đăng ký." };
		mResources.msg = "Tin nhắn";
		mResources.msgg = new string[2] { "Tin", "nhắn" };
		...
		mResources.acc = "TK";
		mResources.pwd = "MK";
		mResources.goToWebForPassword = "Quên thì chịu chứ cứu thể đ nào được";
		...
		mResources.char_name_long = "Tên nhân vật không được quá 20 kí tự";
		...
		mResources.mainTab1 = new string[5][]
		{
			new string[2] { "Nhiệm", "Vụ" },
			new string[2] {"Bản","Thân"},
			new string[2] { "Hành", "Trang" },
			new string[2] { "Kỹ", "Năng" },
			new string[2] { "Chức", "Năng" }
		};
		mResources.mainTab2 = new string[6][]
		{
			new string[2] { "Nhiệm", "Vụ" },
            new string[2] {"Bản","Thân"},
            new string[2] { "Hành", "Trang" },
		...
		mResources.petMainTab2 = new string[3][]
		{
			new string[2] { "Đệ", "Tử" },
            new string[2] { "Kỹ", "Năng" },
            new string[2] { "Trạng", "Thái" }
		...
		mResources.chestt = new string[2] { "Rương", "Đồ" };
		mResources.inventory = new string[2] { "Hành", "Trang" };
		mResources.combine = new string[2] { "Kết", "hợp" };
		mResources.mapp = new string[2] { "Bản", "đồ" };
		mResources.item_give = new string[2] { "Item", "cho" };
		mResources.item_receive = new string[2] { "Item", "nhận" };
		mResources.zonee = new string[2] { "Khu", "Vực" };
		...
		mResources.memberr = new string[2] { "Thành", "viên" };
		mResources.chatClan = new string[2] { "Chat", "bang" };
		mResources.leaveClan = new string[2] { "Rời", "bang" };
		mResources.createClan = new string[2] { "Lập", "bang" };
		mResources.findClan = new string[2] { "Tìm", "bang" };
		mResources.khau_hieuu = new string[2] { "Khẩu", "hiệu" };
		mResources.bieu_tuongg = new string[2] { "Biểu", "tượng" };
		mResources.request_pea2 = new string[2] { "Xin", "đậu" };
		...
		mResources.clanEmpty = new string[5] { "Hiện tại bang chỉ có", " 1 thành viên là bạn.", " Xin chờ có người xin vào.", " Bạn có thể chọn vào nhân vật", " khác để mời họ vào bang" };
