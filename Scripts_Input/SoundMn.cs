...
public class SoundMn
{
    ...
    public static void init(AssetManager ac)
    {
        ...
        isClick = Rms.loadRmsInt("isClick") == 1;
    }
    ...
    {
        Sound.init(new int[3]
        { AIR_SHIP, RAIN, TAITAONANGLUONG }, new int[40]
        {
            ...
            FIREWORK, KAMEX10_0, KAMEX10_1, DESTROY_0, DESTROY_1, MAFUBA_0, MAFUBA_1, MAFUBA_2, DESTROY_2,JoinGame
        });
    }
    ...
    public void getStrOption()
    {
        try
        {
            ...
            if (Main.isPC)
            {
                ...
                GameCanvas.lowGraphic ? "Chuyển sang cấu hình cao" : "Chuyển sang cấu hình thấp",
            ...
            (!isClick) ? ("Bật Phím Tắt") : ("Tắt Phím Tắt")
            };
        }
        catch { }
    }
    ...
    public void changeisClick()
    {
        if (isClick)
        {
            Rms.saveRmsInt("isClick", 0);
            isClick = !isClick;
        }
        else
        {
            Rms.saveRmsInt("isClick", 1);
            isClick = !isClick;
        }
        getStrOption();
    }
