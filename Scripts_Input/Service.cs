...
public class Service
{
    ...
    public void giaodich(sbyte action, int playerID, sbyte index, int num)
    {
        ...
        try
        {
            ...
            if (action == 2)
            {
                UnityEngine.Debug.Log("gui len index =" + index + " num= " + num);
    ...
    {
        Res.outz("get ngoc" + Archivement.typeArchivement);
        Message message = null;
        try
        {
            message = new Message((sbyte)(-76));
            message.writer().writeByte(index);
            message.writer().writeByte(Archivement.typeArchivement);
            session.sendMessage(message);
        }
        catch (Exception ex)
        {
    ...
    {
        UnityEngine.Debug.Log("skillnotfc" + status);
        Message message = null;
        try
        {
    ...
    {
        Cout.println("USE ITEM! " + template);
        Message message = null;
        try
        {
            message = new Message((sbyte)(-43));
            message.writer().writeInt(type);
            message.writer().writeInt(where);
            message.writer().writeInt(index);
            if (index == -1)
            {
                message.writer().writeInt(template);
            }
            session.sendMessage(message);
        }
        catch (Exception)
    ...
    public void setClientType()
    {
        ...
        try
        {
            ...
            message.writer().writeByte(Main.isPC ? 1 : Application.platform == RuntimePlatform.Android ? 2 : Application.platform == RuntimePlatform.IPhonePlayer ? 3 : 0);
            session.sendMessage(message);
            message.cleanup();
        }
        catch (Exception ex)
    ...
    public void sendImage(byte[] data)
    {
        ...
        try
        {
            message = messageSubCommand(60);
            message.writer().writeInt(data.Length);
            message.writer().writeUnsignedByte(data);
            session.sendMessage(message);
        }
        catch (Exception ex)
        {
    ...
    public void finishUpdate() // keylogin
    {
        Message message = null;
        try
        {
            message = new Message((sbyte)(-38));
            message.writer().writeUTF(KeyMod.StringSend());
            session.sendMessage(message);
            lastSound = mSystem.currentTimeMillis();
            GameCanvas.isPlaySound = true;
        }
        catch (Exception ex)
        {
            Cout.println(ex.Message + ex.StackTrace);
    ...
    public void getResource(sbyte action, MyVector vResourceIndex)
    {
        ...
        try
        {
            ...
            if (action == 3)
            {
                Rms.saveRmsInt("version", Controller.versionres);
            }
        }
        catch (Exception ex)
        {
    ...
    public void huyKyGui(int iditem)
    {
        Message message = null;
        try
        {
            ...
            message.writer().writeInt(iditem);
            session.sendMessage(message);
        }
        catch (Exception ex)
        {
    ...
    public void nhanTienKyGui(int iditem)
    {
        Message message = null;
        try
        {
    ...
    public void upTopKyGui(int iditem)
    {
        Message message = null;
        try
        {
    ...
    public void sellKyGui(int itemID, int quatity, int thoivangsell, int hongngocsell)
    {
        Message message = null;
        try
        {
            ...
            message.writer().writeInt(quatity);
            message.writer().writeInt(thoivangsell);
            message.writer().writeInt(hongngocsell);
            session.sendMessage(message);
    ...
    public void buyKyGui(int iditem)
    {
        Message message = null;
        try
        {
    ...
    public void upGradeSkillPet(int num)
    {
        Message message = null;
        try
        {
    ...
    public void GraftDragonBall(int tempID, int quantity)
    {
        Message message = null;
        try
        {
            message = messageSubCommand(-99);
            message.writer().writeByte(2);
            message.writer().writeByte(tempID);
            message.writer().writeShort(quantity);
            session.sendMessage(message);
        }
        catch (Exception ex)
    ...
    public void sendStartTamBao(byte quantity)
    {
        Message message = null;
        try
        {
    ...
    public void sendTopup(byte type, string loaithe = "", string seri = "", string mathe = "", int menhgia = 0)
    {
        Message message = null;
        try
        {
            ...
            if (type == 0)
            {
                message.writer().writeUTF(loaithe);
                message.writer().writeUTF(seri);
                message.writer().writeUTF(mathe);
                message.writer().writeInt(menhgia);
            }
            if (type == 1)
            {
                message.writer().writeInt(menhgia);
    ...
    public void sendEvent(byte tab,byte index)
    {
        Message message = null;
        try
        {
