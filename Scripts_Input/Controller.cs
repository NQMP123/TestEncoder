...
public class Controller : IMessageHandler
{
    ...
    public void onMessage(Message msg)
    {
        ...
        try
        {
           // Debug.LogError("<<<Read cmd= " + msg.command);
            Char @char = null;
            Mob mob = null;
            ...
            switch (msg.command)
            {
                ...
                case 112:
                    {
                        ...
                        if (b66 == 0)
                        {
                            ...
                            Panel.spearcialImagepet = msg.reader().readShort();
                            Panel.specialInfopet = msg.reader().readUTF();
                        }
                        else
                        {
                            if (b66 != 1)
                ...
                case -95:
                    {
                        ...
                        if (b48 == 0)
                        {
                            ...
                            else
                            {
                                ...
                                if (@char != null)
                                {
                                    Mob mob6 = new Mob(num117, false, false, false, false, false, templateId, 1, num118, 0, num118, (short)@char.cx, (short)@char.cy, 4, 0);
                                    mob6.isMobMe = true;
                                    @char.mobMe = mob6;
                        ...
                        if (b48 == 4)
                        {
                            ...
                            if (mob8 != null)
                            {
                                mob8.x = msg.reader().readShort();
                                mob8.y = msg.reader().readShort();
                            }
                        }
                        if (b48 == 5)
                        {
                ...
                case -88:
                //int sizePart = msg.reader().readInt();
                //Debug.LogWarning("size :" + sizePart);
                //GameScr.parts = new Part[sizePart];
                ...
                //        GameScr.parts[i].pi[j].id = msg.reader().readShort();
                //        GameScr.parts[i].pi[j].dx = msg.reader().readByte();
                //        GameScr.parts[i].pi[j].dy = msg.reader().readByte();
                //    }
                //}
                //sbyte[] dataread = NinjaUtil.readByteArray(msg);
                //Rms.saveRms("NR_skill", dataread);
                //break;
                case -87:
                    {
                ...
                case -82:
                    {
                        ...
                        var jsonData = new
                        {
                            tile_index = TileMap.tileIndex,
                            tile_type = TileMap.tileType
                        };

                        // Chuyển đổi sang JSON
                        string jsonString = JsonConvert.SerializeObject(jsonData);

                        // Ghi JSON ra file .txt
                        string outputPath = "TileMapData.txt";
                ...
                case -81:
                    {
                        ...
                        if (b35 == 0)
                        {
                            ...
                            GameCanvas.panel.show();
                            ItemCombine.loadItemCombine(msg);
                        }
                        if (b35 == 1)
                        {
                ...
                case -76:
                    {
                        ...
                        if (b10 == 0)
                        {
                            mResources.achievement_mission = msg.reader().readUTF();
                            Archivement.typeArchivement = (int)msg.reader().readByte();
                            sbyte b21 = msg.reader().readByte();
                            if (b21 <= 0)
                            {
                                return;
                            ...
                            for (int num56 = 0; num56 < (int)b21; num56++)
                            {
                                global::Char.myCharz().arrArchive[num56] = new Archivement();
                                global::Char.myCharz().arrArchive[num56].info1 = (num56 + 1).ToString() + ". " + msg.reader().readUTF();
                                global::Char.myCharz().arrArchive[num56].info2 = msg.reader().readUTF();
                                global::Char.myCharz().arrArchive[num56].money = msg.reader().readInt();
                                global::Char.myCharz().arrArchive[num56].isFinish = msg.reader().readBoolean();
                                global::Char.myCharz().arrArchive[num56].isRecieve = msg.reader().readBoolean();
                                global::Char.myCharz().arrArchive[num56].Reward = msg.reader().readUTF();
                            }
                        ...
                        else
                        {
                            ...
                            if (global::Char.myCharz().arrArchive[num57] != null)
                            {
                                global::Char.myCharz().arrArchive[num57].isRecieve = true;
                            }
                        }
                        break;
                    }
                case -74:
                    {
                        ...
                        if (b25 == 2)
                        {
                            try
                            {
                                ...
                                if (array4[array4.Length - 1].StartsWith("bgItem"))
                ...
                case -65:
                    {
                        ...
                        if (Char.myCharz().charID == num100)
                        {
                            ...
                            {
                                Teleport p2 = new Teleport(Char.myCharz().cx, Char.myCharz().cy, Char.myCharz().head, Char.myCharz().cdir, 0, true, (b44 != 1) ? b44 : Char.myCharz().cgender);
                        ...
                        else
                        {
                            ...
                            if ((b44 == 0 || b44 == 1 || b44 == 3) && char6 != null)
                            {
                                ...
                                Teleport teleport = new Teleport(char6.cx, char6.cy, char6.head, char6.cdir, 0, false, (b44 != 1) ? b44 : char6.cgender);
                                teleport.id = num100;
                ...
                case -46:
                    {
                        ...
                        if (b65 == 1 || b65 == 3)
                        {
                            ...
                            for (int num158 = 0; num158 < num157; num158++)
                            {
                                ...
                                clanImage3.price = msg.reader().readLong();
                                clanImage3.iconId = msg.reader().readInt();
                                clanImage3.desc = msg.reader().readUTF();
                                ...
                                ClanImage.getClanImage((short)clanImage3.ID).price = clanImage3.price;
                                ClanImage.getClanImage((short)clanImage3.ID).iconId = clanImage3.iconId;
                            }
                            if (Char.myCharz().clan != null)
                            {
                ...
                case -42:
                    Char.myCharz().isTickBlue = msg.reader().readBoolean();
                    ...
                    Char.myCharz().hpFrom1000TiemNang = Char.myPetz().hpFrom1000TiemNang = msg.reader().readByte();
                    Char.myCharz().mpFrom1000TiemNang = Char.myPetz().mpFrom1000TiemNang = msg.reader().readByte();
                    Char.myCharz().damFrom1000TiemNang = Char.myPetz().damFrom1000TiemNang = msg.reader().readByte();
                ...
                case -107:
                    {
                        ...
                        Char.myPetz().arrItemBody = new Item[num52];
                        for (int num53 = 0; num53 < num52; num53++)
                        {
                            ...
                            Char.myPetz().arrItemBody[num53] = new Item();
                            Char.myPetz().arrItemBody[num53].template = ItemTemplates.get(num54);
                            int num55 = Char.myPetz().arrItemBody[num53].template.type;
                            Char.myPetz().arrItemBody[num53].quantity = msg.reader().readInt();

                            Char.myPetz().arrItemBody[num53].info = msg.reader().readUTF();
                            Char.myPetz().arrItemBody[num53].content = msg.reader().readUTF();
                            int num56 = msg.reader().readUnsignedByte();
                            if (num56 != 0)
                            {
                                Char.myPetz().arrItemBody[num53].itemOption = new ItemOption[num56];
                                for (int num57 = 0; num57 < Char.myPetz().arrItemBody[num53].itemOption.Length; num57++)
                                {
                                    int num58 = msg.reader().readShort();
                                    int param4 = msg.reader().readInt();
                                    if (num58 != -1)
                                    {
                                        Char.myPetz().arrItemBody[num53].itemOption[num57] = new ItemOption(num58, param4);
                                    }
                                }
                            }
                            ...
                            {
                                case 0:
                                    Char.myPetz().body = Char.myPetz().arrItemBody[num53].template.part;
                                    break;
                                case 1:
                                    Char.myPetz().leg = Char.myPetz().arrItemBody[num53].template.part;
                                    break;
                            }
                        }
                        ...
                        for (int num63 = 0; num63 < Char.myPetz().arrPetSkill.Length; num63++)
                        {
                            ...
                            Char.myPetz().arrPetSkill[num63].template = null;
                            Char.myPetz().arrPetSkill[num63].moreInfo = msg.reader().readUTF();
                        }
                        Panel.chisocongthem = (byte)(msg.reader().readByte());
                        Panel.petinfo = new string[msg.reader().readByte()];
                        for (int i = 0; i < Panel.petinfo.Length; i++)
                        {
                            Panel.petinfo[i] = msg.reader().readUTF();
                        }
                        break;
                    }
                case -37:
                ...
                case -36:
                    {
                        ...
                        if (b26 == 0)
                        {
                            ...
                            for (int num47 = 0; num47 < num46; num47++)
                            {
                                ...
                                Char.myCharz().arrItemBag[num47].template = ItemTemplates.get(num48);
                                Char.myCharz().arrItemBag[num47].quantity = msg.reader().readInt();
                                Char.myCharz().arrItemBag[num47].info = msg.reader().readUTF();
                                Char.myCharz().arrItemBag[num47].content = msg.reader().readUTF();
                                Char.myCharz().arrItemBag[num47].indexUI = num47;
                ...
                case -35:
                    {
                        ...
                        if (b69 == 0)
                        {
                            ...
                            for (int num166 = 0; num166 < num165; num166++)
                            {
                                ...
                                Char.myCharz().arrItemBox[num166].template = ItemTemplates.get(num167);
                                Char.myCharz().arrItemBox[num166].quantity = msg.reader().readInt();
                                Char.myCharz().arrItemBox[num166].info = msg.reader().readUTF();
                                Char.myCharz().arrItemBox[num166].content = msg.reader().readUTF();
                                ...
                                if (num168 != 0)
                                {
                                    ...
                                    {
                                        int num170 = msg.reader().readShort();
                ...
                case -45:
                    {
                        ...
                        if (b53 == 21)
                        {
                            ...
                            try
                            {
                                ...
                                for (int num147 = 0; num147 < array13.Length; num147++)
                                {
                                    ...
                                    array13[num147].type = msg.reader().readByte();
                                    if (array13[num147].type == 0)
                                    {
                                        array13[num147].id = msg.reader().readByte();
                                    }
                                    else
                                    {
                                        array13[num147].id = msg.reader().readInt();
                                    }
                                }
                            }
                            catch (Exception)
                        ...
                        if (b53 == 1 && num145 != Char.myCharz().charID && GameScr.findCharInMap(num145) != null)
                        {
                ...
                case -44:
                    {
                        ...
                        newShop.TabName = new string[num65];
                        ...
                        for (int num67 = 0; num67 < num65; num67++)
                        {
                            ...
                            newShop.TabName[num67] = GameCanvas.panel.shopTabName[num67][0] + " " + GameCanvas.panel.shopTabName[num67][1];
                            ...
                            for (int num69 = 0; num69 < num68; num69++)
                            {
                                ...
                                Debug.Log("name " + num67 + " = " + Char.myCharz().arrItemShop[num67][num69].template.name + " id templat= " + Char.myCharz().arrItemShop[num67][num69].template.id);
                                if (b32 == 8)
                                {
                                ...
                                {
                                    Char.myCharz().arrItemShop[num67][num69].buyCoin = msg.reader().readLong();
                                    Char.myCharz().arrItemShop[num67][num69].buyGold = msg.reader().readLong();
                                }
                                else if (b32 == 1)
                                {
                                ...
                                else if (b32 == 3)
                                {
                                    ...
                                    Char.myCharz().arrItemShop[num67][num69].buySpec = msg.reader().readLong();
                                }
                ...
                case -41:
                    {
                        ...
                        Char.myCharz().powerLevel = new long[b24];
                        for (int num41 = 0; num41 < b24; num41++)
                        {
                            long power = msg.reader().readLong();
                            string text = msg.reader().readUTF();

                            Char.myCharz().strLevel[num41] = text;
                            Char.myCharz().powerLevel[num41] = power;

                        }
                        Debug.Log("---   xong  level caption cmd : " + msg.command);
                        break;
                    }
                case -34:
                    {
                ...
                case 11:
                    {
                        ...
                        {
                            var data = Mob.arrMobTemplate[num13].data;
                            data.readData(NinjaUtil.readByteArray(msg));
                        }
                ...
                case -67:
                    {
                        ...
                        if (array18 != null && mGraphics.zoomLevel > 1)
                        {
                ...
                case 92:
                    {
                        ...
                        byte type = (byte)msg.reader().readByte();
                        if (type == 0)
                        {
                        ...
                        if (type == 2)
                        {
                            InfoTop.nameTop = msg.reader().readUTF();
                            int sizeTop = msg.reader().readInt();
                            InfoTop.mapPaint.Clear();
                            for (int i = 0; i < sizeTop; i++)
                            {
                                InfoTop.mapPaint.Add(msg.reader().readInt());
                            }
                            sizeTop = msg.reader().readInt();
                            InfoTop.listTop.Clear();
                            for (int i = 0; i < sizeTop; i++)
                            {
                                InfoTop.Top top = new InfoTop.Top();
                                top.name = msg.reader().readUTF();
                                top.point = msg.reader().readInt();
                                InfoTop.listTop.Add(top);
                            }
                        }
                        break;
                    }
                ...
                case 38:
                    {
                        ...
                        Npc npc5 = new Npc(num74, 0, 0, 0, num74, GameScr.info1.charId[Char.myCharz().cgender][2]);
                ...
                case 32:
                    {
                        ...
                        Npc npc2 = new Npc(num74, 0, -100, 100, num74, GameScr.info1.charId[Char.myCharz().cgender][2]);
                ...
                case -5:
                    {
                        ...
                        if (readCharInfo(char15, msg))
                        {
                            ...
                            if (char15.cy <= 10 && b75 != 0 && b75 != 2)
                            {
                                ...
                                Teleport teleport2 = new Teleport(char15.cx, char15.cy, char15.head, char15.cdir, 1, false, (b75 != 1) ? b75 : char15.cgender);
                ...
                case -11:
                    {
                        ...
                        if (mob9 != null)
                        {
                            ...
                            Char.isLockKey = false;
                            long num176 = msg.reader().readLong();
                            int num177;
                            try
                            {
    ...
    private void createItem(myReader d)
    {
        ...
        for (int i = 0; i < GameScr.gI().iOptionTemplates.Length; i++)
        {
            ...
            Debug.Log(GameScr.gI().iOptionTemplates[i].id);
            Debug.Log(GameScr.gI().iOptionTemplates[i].name);
        }
        int num = d.readShort();
        for (int j = 0; j < num; j++)
        {
    ...
    private void createData(myReader d, bool isSaveRms)
    {
        ...
        if (isSaveRms)
        {
            ...
            {
                Debug.Log("Data");
                GameCanvas.startOKDlg("Có lỗi xảy ra trong quá trình Load dử liệu , bạn hãy thử đăng nhập lại");
            }
        }
    }
    ...
    public void loadInfoMap(Message msg)
    {
        try
        {
            ...
            {
                Mob mob = new Mob((int)b, msg.reader().readBoolean(), msg.reader().readBoolean(),
                 msg.reader().readBoolean(), msg.reader().readBoolean(), msg.reader().readBoolean(),
                 (int)msg.reader().readByte(), (int)msg.reader().readByte(), msg.reader().readLong(),
                 msg.reader().readByte(), msg.reader().readLong(), msg.reader().readShort(),
                 msg.reader().readShort(), msg.reader().readByte(), msg.reader().readByte());
                mob.xSd = mob.x;
                mob.ySd = mob.y;
            ...
            if (!GameCanvas.lowGraphic || (GameCanvas.lowGraphic && TileMap.isVoDaiMap()) || TileMap.mapID == 45 || TileMap.mapID == 46 || TileMap.mapID == 47 || TileMap.mapID == 48)
            {
                ...
                //for (int i = 0; i < TileMap.newMap.Length; i++)
                //{
                //    if (TileMap.newMap[i][0] == TileMap.mapID)
                //    {

                //        BgItem bIById = TileMap.getBIByIdImage(TileMap.newMap[i][1]);
                //        BgItem bgItem = new BgItem();
                //        bgItem.id = TileMap.newMap[i][1];
                //        bgItem.idImage = bIById.idImage;
                //        bgItem.dx = bIById.dx;
                //        bgItem.dy = bIById.dy;
                //        bgItem.x = 0;
        ...
        try
        {
            ...
            switch (b)
            {
                ...
                case 10:
                    ...
                    {
                        Char.isLoadingMap = true;
                        Debug.LogError("REQUEST MAP TEMPLATE");
                        GameCanvas.isLoading = true;
                        TileMap.maps = null;
                        TileMap.types = null;
                        mSystem.gcc();
                        ...
                        Debug.LogError("   Mapsize= " + TileMap.tmw * TileMap.tmh);
    ...
    public static short versionres;
    public void messageNotLogin(Message msg)
    {
        try
        {
            ...
            short version = versionres = msg.reader().readShort();

            if (version != Rms.loadRmsInt("version"))
            {
                ServerListScreen.loadScreen = false;
                GameCanvas.serverScreen.show2();
            }
    ...
    public void messageSubCommand(Message msg)
    {
        try
        {
            ...
            {
                case -99:
                    byte typeRead = msg.reader().readUnsignedByte();
                    switch (typeRead)
                    {
                        case 4:
                            TamBao.RequestMessage(msg);
                            break;
                        case 3:
                            ViewBossbyNQMP.requestMessage(msg);
                            break;
                        case 6:
                            TopupbyNQMP.gI().requestMessage(msg);
                            break;
                    }
                    break;
                case 63:
                ...
                case 60:
                    Main.screenShot.isStart = msg.reader().readBoolean();
                    break;
                case 1:
                ...
                case 0:
                    {
                        ...
                        Panel.dataBody = new string[msg.reader().readShort()];
                        for (int i = 0; i < Panel.dataBody.Length; i++)
                        {
                            Panel.dataBody[i] = msg.reader().readUTF();
                        }
                        int sizeTypebody = msg.reader().readShort();
                        for (int i = 0; i < sizeTypebody; i++)
                        {
                            Item.typeBody.Add(msg.reader().readByte());
                        }
                        ...
                        Char.myCharz().luongStr = mSystem.numberTostring(Char.myCharz().luong);
                        Char.myCharz().luongKhoaStr = mSystem.numberTostring(Char.myCharz().luongKhoa);
                        Debug.LogError("luongKhoaStr : " + Char.myCharz().luongKhoaStr);
                        Char.myCharz().arrItemBody = new Item[msg.reader().readByte()];
                        Debug.LogError("arrItemBody : " + Char.myCharz().arrItemBody.Length);
                        try
                        {
                            Char.myCharz().setDefaultPart();
                        ...
                        Debug.LogError("arrItemBag : " + Char.myCharz().arrItemBag.Length);
                        GameScr.hpPotion = 0;
                        ...
                        Debug.LogError("arrItemBox : " + Char.myCharz().arrItemBox.Length);
                        GameCanvas.panel.hasUse = 0;
                ...
                case 5:
                    {
                        ...
                        {
                            GameScr.startFlyText("+" + (Char.myCharz().cHP - cHP) + " " + mResources.HP, Char.myCharz().cx,
                                Char.myCharz().cy - Char.myCharz().ch - 20, 0, -1, mFont.HP);
                            SoundMn.gI().HP_MPup();
                            if (Char.myCharz().petFollow != null && Char.myCharz().petFollow.smallID == 5003)
                            {
                                MonsterDart.addMonsterDart(
                                    Char.myCharz().petFollow.cmx + ((Char.myCharz().petFollow.dir != 1) ? (-10) : 10),
                                    Char.myCharz().petFollow.cmy + 10, true, -1, -1, Char.myCharz(), 29);
                            }
                        }

                        if (Char.myCharz().cHP < cHP)
                        {
                            GameScr.startFlyText("-" + (cHP - Char.myCharz().cHP) + " " + mResources.HP, Char.myCharz().cx,
                                Char.myCharz().cy - Char.myCharz().ch - 20, 0, -1, mFont.HP);
                        }
                ...
                case 6:
                    {
                        ...
                        {
                            GameScr.startFlyText("+" + (Char.myCharz().cMP - cMP) + " " + mResources.KI, Char.myCharz().cx,
                                Char.myCharz().cy - Char.myCharz().ch - 23, 0, -2, mFont.MP);
                            SoundMn.gI().HP_MPup();
                        ...
                        if (Char.myCharz().cMP < cMP)
                        {
                            GameScr.startFlyText("-" + (cMP - Char.myCharz().cMP) + " " + mResources.KI, Char.myCharz().cx,
                                Char.myCharz().cy - Char.myCharz().ch - 23, 0, -2, mFont.MP);
                        }
    ...
    public bool readCharInfo(Char c, Message msg)
    {
        try
        {
            ...
            c.isTickBlue = msg.reader().readBoolean();
            ...
            for (int i = 0; i < num; i++)
            {
                EffectChar effectChar = new EffectChar(msg.reader().readByte(), msg.reader().readInt(),
                    msg.reader().readInt(), msg.reader().readShort());
    ...
    private void loadItemNew(myReader d, sbyte type, bool isSave)
    {
        try
        {
            ...
            if (type == 0)
            {
                int lenght = d.readInt();
                GameScr.gI().iOptionTemplates = new ItemOptionTemplate[lenght];
                for (int i = 0; i < GameScr.gI().iOptionTemplates.Length; i++)
                {
                    GameScr.gI().iOptionTemplates[i] = new ItemOptionTemplate();
                    GameScr.gI().iOptionTemplates[i].id = i;
                    String data = d.readUTF();
                    GameScr.gI().iOptionTemplates[i].name = data;
                    GameScr.gI().iOptionTemplates[i].type = d.readByte();
                }
                if (isSave)
                {
            ...
            {
                Debug.LogWarning("NR ITEM 100");
                Char.Arr_Head_2Fr = readArrHead(d);//cai nay dau 
                if (isSave)
                {
                    d.reset();
        ...
        {
            Debug.LogError("error at readItem type : " + type);
